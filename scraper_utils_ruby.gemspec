...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{planningalerts scraper utilities}
  spec.description   = %q{Utilities to help make planningalerts scrapers, especially multis easier to develop, run and debug.}
